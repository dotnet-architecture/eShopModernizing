...
function GenerateCerts {
    ...
    Write "CA certificate generated"

    $splat = @{
        CertStoreLocation = "Cert:\CurrentUser\My";
        DnsName = "yourserver.westus.cloudapp.azure.com", "localhost", "yourserver";        
        Signer = $rootCert ;
        KeyExportPolicy = "Exportable";
    ...
    Write "Server certificate generated"
    ...
    Write "Server private key generated"
    ...
    Write "Client certificate generated"
    ...
    Write "Client private key generated"
}

GenerateCerts

Write "CA, Server and Client Certificate files should be generated in this same folder"
